...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (strlen($_POST['name']) < 5 || strlen($_POST['name']) > 50) {
        ...
        $sql = "INSERT INTO hotel_management (username, password) VALUES ('$_POST[name]', '$_POST[password]')";

    if(!mysqli_query($con,$sql)) {
        die('Error:' . mysqli_error($con));
    }
    else {
        echo "<script>alert('This hotel management account has been created!');</script>";
    }
...
<body>
    <form id="request-form" method="post">
        ...
        <button type="submit">Register as Hotel Management</button>
    </form>
</body>
</html>
