...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (strlen($_POST['name']) < 5 || strlen($_POST['name']) > 50) {
        ...
        $sql = "INSERT INTO transport_management (username, password) VALUES ('$_POST[name]', '$_POST[password]')";

    if(!mysqli_query($con,$sql)) {
        die('Error:' . mysqli_error($con));
    }
    else {
        echo "<script>alert('This transport management account has been created!');</script>";
    }
...
<body>
    <form id="request-form" method="post">
        ...
        <button type="submit">Register as Transport Management</button>
    </form>
</body>
</html>
