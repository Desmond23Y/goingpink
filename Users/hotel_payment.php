...
<body>
    ...
    <form action="" method="POST">
        ...
        <input type="date" id="expiration_date" name="expiration_date" pattern="^(0[1-9]|1[0-2])\/\d{2}$" placeholder="MM/YY" required>
        <input type="text" id="cvc" name="cvc" pattern="[0-9]{3}" placeholder="MM/YY" required><br><br>
